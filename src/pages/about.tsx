        ...
        {isOpen && (
            ...
            <div className="bg-gray-200 flex flex-col items-center justify-center min-h-screen py-2 w-full">
                    ...
                    <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full text-slate-800">
                        <Link
                            href="/"
                            className="p-6 mt-6 text-left border border-solid border-slate-500 hover:border-blue-600 w-96 h-96 rounded-xl hover:text-blue-600 focus:text-blue-600"
                        >
                        ...
                        <Link
                            href="/courses"
                            className="p-6 mt-6 text-left border border-solid border-slate-500 hover:border-blue-600 w-96 h-96 rounded-lg hover:text-blue-600 focus:text-blue-600"
                        >
                            <h3 className="text-2xl font-bold">View our Jobs List &rarr;</h3>
                            <p className="mt-4 text-xl">Check any jobs from our database which contains data from 2021. Use the search bar to pinpoint your dream job.</p>
						...
						<Image src="/Github_Invertocat_Dark.svg" width={32} height={32} alt="Logo" className=" ml-2 mb-2" />
                    	</a>
                    </div>
